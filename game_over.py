    ...
    while running:
            ...
            while running:
                ...
                for ev in pygame.event.get():
                    if ev.type == pygame.QUIT:
                        ...
                        if is_mouse_over_button(mouse,
                                                (button_x, volume_increase_button_y, button_width, button_height)):
                            volume = min(volume + 0.1, 1.0)  # Cap at 1.0
                            mixer.music.set_volume(volume)
                            # Increase volume

                        elif is_mouse_over_button(mouse,
                                                  (button_x, volume_decrease_button_y, button_width, button_height)):
                ...
                # Draw buttons
                create_button(screen, "Back", ikea_yellow, button_x, back_button_y, button_width, button_height,
                              optimafont)
                create_button(screen, "Volume +", ikea_yellow, button_x, volume_increase_button_y, button_width,
                              button_height, optimafont)
                create_button(screen, "Volume -", ikea_yellow, button_x, volume_decrease_button_y, button_width,
                              button_height, optimafont)
                create_button(screen, "Mute/Unmute", ikea_yellow, button_x, volume_mute_button_y, button_width,
                              button_height, optimafont)
        ...
        def rules():
            ...
            while running:
                ...
                # Create buttons
                create_button(screen, "Controls", ikea_yellow, button_x, controls_button_y, button_width, button_height,
                              optimafont)
                create_button(screen, "Power-ups", ikea_yellow, button_x, powerups_button_y, button_width,
                              button_height, optimafont)
                create_button(screen, "Weapons", ikea_yellow, button_x, weapons_button_y, button_width, button_height,
                              optimafont)
