...
class Player(pygame.sprite.Sprite):
    ...
    def __init__(self):
        ...
        self.invincible = {
            "right": pygame.image.load("images\Characters\Kalle\Kalle_Postman_Right_invincible1.1.png"),
            "left": pygame.image.load("images\Characters\Kalle\Kalle_Postman_Left_invincible1.1.png")
            }
        
        self.hurt = {
            "left":pygame.image.load("images\Characters\Kalle\Kalle_Hurt_L.png"),
            "right":pygame.image.load("images\Characters\Kalle\Kalle_Hurt.png")
            }
