...
class Freeze(PowerUp):
    ...
    def power_affect_game(self, target, target2):
        ...
        for enemy in target:
            ...
            # Draw the enemy with a new color (e.g., red for slowed enemies)
            pygame.draw.rect(new_image, (255, 255, 255), (20, 20, 30, 20))  # Red body
            ...
            pygame.draw.circle(new_image, (0, 0, 0), (15, 15), 2)  # Black eye
            pygame.draw.line(new_image, (0, 0, 0), (12, 20), (18, 20), 2)  # Mouth
            pygame.draw.polygon(new_image, (255, 255, 255), [(22, 20), (26, 10), (30, 20)])  # Spike 1
            pygame.draw.polygon(new_image, (255, 255, 255), [(30, 20), (34, 10), (38, 20)])  # Spike 2
